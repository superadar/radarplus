...
#define MAKE_ERROR(code, desc) { code, { #code, desc } }
            ...
            std::pair<char const* const, char const* const>> const results
    {
        ...
        MAKE_ERROR(tecNO_DST,                 "Destination does not exist. Send SRC to create it."),
        MAKE_ERROR(tecNO_DST_INSUF_XRP,       "Destination does not exist. Too little SRC sent to create it."),
        ...
        MAKE_ERROR(tecUNFUNDED,               "Not enough SRC to satisfy the reserve requirement."),
        MAKE_ERROR(tecUNFUNDED_ADD,           "DEPRECATED."),
        MAKE_ERROR(tecUNFUNDED_OFFER,         "Insufficient balance to fund created offer."),
        MAKE_ERROR(tecUNFUNDED_PAYMENT,       "Insufficient SRC balance to send."),
        ...
        MAKE_ERROR(temBAD_FEE,                "Invalid fee, negative or not SRC."),
        ...
        MAKE_ERROR(temBAD_SEND_XRP_LIMIT,     "Malformed: Limit quality is not allowed for SRC to SRC."),
        MAKE_ERROR(temBAD_SEND_XRP_MAX,       "Malformed: Send max is not allowed for SRC to SRC."),
        MAKE_ERROR(temBAD_SEND_XRP_NO_DIRECT, "Malformed: No Ripple direct is not allowed for SRC to SRC."),
        MAKE_ERROR(temBAD_SEND_XRP_PARTIAL,   "Malformed: Partial payment is not allowed for SRC to SRC."),
        MAKE_ERROR(temBAD_SEND_XRP_PATHS,     "Malformed: Paths are not allowed for SRC to SRC."),
